...
v9:
V10: Serial communication
*/

/*
Blynk server information

User: component@gmail.com
Pass: Neng@1325
Server: blynk.iot-cm.com:9443
When config with wifi use port 8080 !? Do investigate, why it work like this
Command: http://49.229.108.138:8080/XhrSKV2HFQi-3YOIf8NsL5_caLPW_aS0/update/D2?value=1
Token:
AWS = XhrSKV2HFQi-3YOIf8NsL5_caLPW_aS0
New Device = uQMDmOCDN934clwd1ERnCo3A37YEs90O
*/
...
//////////////////////////////////////////////
  ...
  // Serial Coomunication with Blynk
  terminal.clear();
  terminal.println("System is start");
  terminal.flush();
...
void updateLedStatus()
{
  ...
  // Use for Blynk notify message
  Blynk.notify("LED Status change !!!");
...
BLYNK_WRITE(V10)
{   
  input_message = param.asStr();
  terminal.print("You said: ");
  terminal.println(input_message);
  terminal.flush();
}
